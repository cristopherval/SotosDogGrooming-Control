...
export const STRINGS = {
  en: {
    ...
    price: 'Price', set_cover: 'Use as main photo', cover_set: 'Main photo updated',
    move_photo: 'Move photo', move_to: 'Move to…',
  ...
  es: {
    ...
    price: 'Precio', set_cover: 'Usar como foto principal', cover_set: 'Foto principal actualizada',
    move_photo: 'Mover foto', move_to: 'Mover a…',
